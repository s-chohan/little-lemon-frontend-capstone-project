        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              Experience authentic Mediterranean cuisine at Little Lemon,
              Chicago&apos;s premier family-owned restaurant since 1995.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#menu" className="text-gray-300 hover:text-yellow-400 transition-colors">Menu</Link></li>
              <li><Link href="/reservations" className="text-gray-300 hover:text-yellow-400 transition-colors">Reservations</Link></li>
            </ul>
          </div>
